...
const stack = [
  ...
  { id: '2', icon: iconQuasar, alt: 'Quasar Framework icon',  tippyContent: 'Quasar Framework'},
  { id: '3', icon: iconTailwind, alt: 'TailwindCss icon',  tippyContent: 'TailwindCss'},
  { id: '4', icon: iconNuxt, alt: 'Nuxt icon',  tippyContent: 'Nuxt'},
  { id: '5', icon: iconReact, alt: 'React icon',  tippyContent: 'React'},
  { id: '6', icon: iconMUI, alt: 'Material UI icon',  tippyContent: 'Material UI'}
]
